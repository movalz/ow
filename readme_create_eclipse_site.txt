...
4. open ow\src\eclipse\net.vtst.ow.eclipse.less.feature\feature.xml in Eclipse
		...
		- check that the list of included plug-ins contains entries
				net.vtst.elipse.easytext,
				net.vtst.elipse.easytext.ui,
				net.vtst.ow.eclipse.less and
				net.vtst.ow.eclipse.less.ui
				in the versions you have entered into the MANIFEST.MFs above
		  (if not:
